<script>
	...
	// async function getNowPlaying() {
	// 	song = await fetch('/api/nowPlaying').then((res) => res.json());
	// }
</script>

<div
	class="group inline-flex px-3 py-1 rounded-md items-center bg-gray-100 transition-colors decoration-none dark:bg-gray-50/10 text-sm {song
